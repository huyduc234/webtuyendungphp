...
switch ($act) {
    ...
    if(isset($_SESSION['username'])){
        ...
        save_recr($iduser, $idrecr);

        echo "<script>
            alert('Đã lưu công việc!');
            window.location.href='index.php?act=info_recr&id=$idrecr';
        </script>";
    } else {
        echo "<script>
            alert('Bạn cần đăng nhập để lưu công việc!');
            window.location.href='index.php?act=signin';
        </script>";
    }
    ...
    if(isset($_SESSION['username']))
    {
        ...
        unsave_recr($iduser, $idrecr);

        echo "<script>
                alert('Đã bỏ lưu công việc');
                location.href='index.php?act=info_recr&id=$idrecr';
              </script>";
    }

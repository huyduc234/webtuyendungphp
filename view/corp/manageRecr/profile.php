                    ...
                    <div class="details-inner d-flex flex-column flex-sm-row justify-content-between">
                        <ul class="mb-2 mb-sm-0 w-25">
                            ...
                            <li class="position-relative">
                                <!-- activeYear -->
                                <input name="activeYear" type="text" class="searchSelect" id="searchjob" min='1980' max='2026' maxlength='4' value="<?= $activeYear !== '' ? $activeYear : '' ?>" placeholder="<?= checknull($activeYear); ?>">
                                <div class="dropdown-content w-100" id="dropdownjob">
                                    <?php for ($i = 1980; $i <= 2026; $i++) { ?>

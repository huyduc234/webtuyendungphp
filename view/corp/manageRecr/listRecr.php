...
<?php if($status == 1){ ?>
    ...
    <a href="index.php?act=infoCvOnRecr&idrec=<?= $id ?>"
       class="btn btn-success text-white position-relative p-1 me-2"
       style="font-size:13px;">
        Đang tuyển

        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
            <?= Count_info_CV($id)['totalCV'] ?>
        </span>
    </a>

    <span class="btn btn-info text-white p-1"
          style="font-size:13px;">
        Đang hiển thị
    </span>
...
<?php } elseif($status == 2){ ?>
    ...
    <span class="btn btn-danger text-white p-1"
          style="font-size:13px;">
        Bị từ chối
    </span>
...
<?php } else { ?>
    ...
    <span class="btn btn-warning text-dark p-1"
          style="font-size:13px;">
        Chờ duyệt
    </span>

        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="title-item">
                    ...
                    <ul>
                        <li>
                            <img data-cfsrc="assets/img/home-three/title-img-two.png" alt="Image" style="display:none;visibility:hidden;">
                            <noscript>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="d-flex w-100 align-items-center flex-column">
                    <div style="width: 100px; height: 100px" class="overflow-hidden rounded-circle mb-3 d-flex justify-content-center align-items-center">
                        <img src='<?= checkUserAvaNull($avatar) ?>' alt='user'>
                    </div>

                    <h3 class="mb-4 w-100 text-center">
                        <?= $name ?>
                    </h3>
                </div>
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= ($activeTab == 'apply') ? 'active' : '' ?>"
                       id="v-pills-messages-tab"
                       data-bs-toggle="pill"
                       href="#v-pills-messages"
                       role="tab"
                       aria-controls="v-pills-messages"
                       aria-selected="<?= ($activeTab == 'apply') ? 'true' : 'false' ?>">
                        <div class="profile-list">
                            <i class="bx bxs-inbox"></i>
                            Danh sách các bài đã ứng tuyển
                        </div>
                    </a>
                     <a class="nav-link <?= ($activeTab == 'saved') ? 'active' : '' ?>"
            ...
            <div class="col-lg-9">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    include "manageCv/listSavedRecr.php";
                    ?>
                </div>
            </div>
        </div>

        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="work-item two three">
                    ...
                    <p>Tạo tài khoản nhanh chóng để truy cập hệ thống cho phép ban quản lý hồ sơ cá nhân và theo dõi quá trình ứng tuyển dễ dàng     </p>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="work-item two three">
                    ...
                    <p>Tìm kiếm và ứng tuyển vào các công việc phù hợp với kỹ năng, kinh nghiệm, mức lương và địa điểm mong muốn một cách nhanh chóng </p>
                </div>
            </div>
            <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                <div class="work-item two three work-border">
                    ...
                    <p>Gửi hồ sơ ứng tuyển trực tiếp chỉ với vài thao tác đơn giản và theo dõi tình trạng ứng tuyển trạng thái đơn ứng tuyển mọi lúc mọi nơi</p>
                </div>
            </div>
        </div>
    </div>
